                                        ...
                                        <form action="/auth-signin-basic">
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <div className="position-relative auth-pass-inputgroup mb-3">
                                                    ...
                                                    <Button color="link" className="position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" id="confirm-password-input"><i className="ri-eye-fill align-middle"></i></Button>
                                                </div>
                                            </div>
