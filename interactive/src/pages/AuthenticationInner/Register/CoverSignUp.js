                                            ...
                                            <div className="p-lg-5 p-4">
                                                ...
                                                <div className="mt-4">
                                                    <form className="needs-validation" noValidate action="index">
                                                        ...
                                                        <div className="mb-4">
                                                            <p className="mb-0 fs-13 text-muted fst-italic">By registering you agree to the Velzon <Link to="#" className="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</Link></p>
                                                        </div>
