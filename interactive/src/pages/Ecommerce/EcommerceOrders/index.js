...
const EcommerceOrders = () => {
  ...
  const { orders, isOrderCreated, isOrderSuccess, error, isOrderAdd, isOrderAddFail, isOrderDelete, isOrderDeleteFail, isOrderUpdate, isOrderUpdateFail } = useSelector((state) => ({
    ...
    isOrderAdd: state.Ecommerce.isOrderAdd,
    isOrderAddFail: state.Ecommerce.isOrderAddFail,
    isOrderDelete: state.Ecommerce.isOrderDelete,
    isOrderDeleteFail: state.Ecommerce.isOrderDeleteFail,
    isOrderUpdate: state.Ecommerce.isOrderUpdate,
    isOrderUpdateFail: state.Ecommerce.isOrderUpdateFail,
  }));
