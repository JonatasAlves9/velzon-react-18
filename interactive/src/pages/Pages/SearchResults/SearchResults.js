                                            ...
                                            <Row className="g-2">
                                                <Col>
                                                    <div className="position-relative mb-3">
                                                        ...
                                                        <Link to="#" className="btn btn-link link-info btn-lg position-absolute end-0 top-0" onClick={toggleOffCanvas}><i className="ri-mic-fill"></i></Link>
                                                    </div>
                                                </Col>
                                    ...
                                    <TabContent activeTab={activeTab} className="text-muted">
                                        <TabPane tabId="1">
                                            ...
                                            <div className="py-3">
                                                ...
                                                <p className="text-info mb-2">https://themesbrand.com/skote/</p>
                                            ...
                                            <div className="py-3">
                                                ...
                                                <p className="text-info mb-2">https://themesbrand.com/minia/react/</p>
                                            ...
                                            <div className="py-3">
                                                ...
                                                <p className="text-info mb-2">https://themesbrand.com/dason/angular/</p>
                                                                ...
                                                                <div className="d-sm-flex">
                                                                    ...
                                                                    <div className="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                        ...
                                                                        <ul className="list-inline mb-0">
                                                                            <li className="list-inline-item"><i className="ri-user-3-fill text-info align-middle me-1"></i> {item.auther}</li>
                                                                            <li className="list-inline-item"><i className="ri-calendar-2-fill text-info align-middle me-1"></i> {item.date}</li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </CardBody>
                                        ...
                                        <TabPane tabId="4">
                                            <Row>
                                                {(video || []).map((item, key) => (
                                                    <Col lg={12} className="video-list" key={key}>
                                                        <div className="list-element mt-4">
                                                            ...
                                                            <p className="text-info">{item.siteLink}</p>
                                                ...
                                                <div className="text-center">
                                                    <button id="loadmore" className="btn btn-link link-info mt-2"><i className="mdi mdi-loading mdi-spin fs-20 align-middle me-2"></i> Load more </button>
                                                </div>
                                            </Row>
                                        </TabPane>
                                    </TabContent>
