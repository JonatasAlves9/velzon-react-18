                            ...
                            <div>
                                <div className="d-flex">
                                    ...
                                    <div className="flex-shrink-0">
                                        <Link to="/pages-profile-settings" className="btn btn-info"><i
                                            ...
                                            <Col xxl={3}>
                                                <Card>
                                                    <CardBody>
                                                        ...
                                                        <Progress value={30} color="info" className="animated-progess custom-progress progress-label" ><div className="label">30%</div> </Progress>
                                                    </CardBody>
                                                </Card>
                                                            ...
                                                            <div className="d-flex align-items-center py-3">
                                                                ...
                                                                <div className="flex-grow-1">
                                                                    <div>
                                                                        ...
                                                                        <p className="text-muted mb-0">Frontend
                                                                            Developer</p>
                                                                    </div>
                                                                </div>
                                                                <div className="flex-shrink-0 ms-2">
                                                                    <button type="button"
                                                                        className="btn btn-sm btn-outline-info"><i
                                                            ...
                                                            <div className="d-flex align-items-center py-3">
                                                                ...
                                                                <div className="flex-grow-1">
                                                                    <div>
                                                                        ...
                                                                        <p className="text-muted mb-0">UI/UX Designer
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                <div className="flex-shrink-0 ms-2">
                                                            ...
                                                            <div className="d-flex align-items-center py-3">
                                                                ...
                                                                <div className="flex-grow-1">
                                                                    <div>
                                                                        ...
                                                                        <p className="text-muted mb-0">Backend
                                                                            Developer</p>
                                                                    </div>
                                                                </div>
                                                                <div className="flex-shrink-0 ms-2">
                                            ...
                                            <CardBody>
                                                <div className="d-flex align-items-center mb-4">
                                                    ...
                                                    <div className="flex-shrink-0">
                                                        ...
                                                        <Label htmlFor="formFile" className="btn btn-primary"><i className="ri-upload-2-fill me-1 align-bottom"></i> Upload
                                                            File</Label>
                                                    </div>
                                                </div>
                                                <Row>
                                                                            ...
                                                                            <td>
                                                                                <div className="d-flex align-items-center">
                                                                                    ...
                                                                                    <div className="ms-3 flex-grow-1">
                                                                                        <h6 className="fs-15 mb-0"><Link to="#" className="link-dark">{item.fileName}</Link>
                                                                                        </h6>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
