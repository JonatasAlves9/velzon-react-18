...
const CrmContacts = () => {
  ...
  const { crmcontacts, isContactCreated, isContactSuccess, error, isContactAdd, isContactAddFail, isContactDelete, isContactDeleteFail, isContactUpdate, isContactUpdateFail } = useSelector((state) => ({
  ...
  }, [dispatch, isContactSuccess, error, isContactAdd, isContactAddFail, isContactDelete, isContactDeleteFail, isContactUpdate, isContactUpdateFail]);
  useEffect(() => {
            ...
            <Col xxl={9}>
              <Card id="contactList">
                ...
                <CardBody>
                  ...
                  {isContactAdd ? <MsgToast msg="Contact Added Successfully" color="success" icon="ri-checkbox-circle-line"/> : null}
                  {isContactAddFail ? <MsgToast msg="Contact Added Failed" color="danger" icon="ri-error-warning-line"/> : null}
                  {isContactDelete ? <MsgToast msg="Contact Deleted Successfully" color="success" icon="ri-checkbox-circle-line"/> : null}
                  {isContactDeleteFail ? <MsgToast msg="Contact Deleted Failed" color="danger" icon="ri-error-warning-line"/> : null}
                  {isContactUpdate ? <MsgToast msg="Contact Updated Successfully" color="success" icon="ri-checkbox-circle-line"/> : null}
                  {isContactUpdateFail ? <MsgToast msg="Contact Updated Failed" color="danger" icon="ri-error-warning-line"/> : null}
