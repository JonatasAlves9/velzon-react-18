...
const CrmCompanies = () => {
  ...
  const { companies, isCompaniesCreated, isCompaniesSuccess, error, isCompaniesAdd, isCompaniesAddFail, isCompaniesDelete, isCompaniesDeleteFail, isCompaniesUpdate, isCompaniesUpdateFail } = useSelector((state) => ({
    ...
    isCompaniesAdd: state.Crm.isCompaniesAdd,
    isCompaniesAddFail: state.Crm.isCompaniesAddFail,
    isCompaniesDelete: state.Crm.isCompaniesDelete,
    isCompaniesDeleteFail: state.Crm.isCompaniesDeleteFail,
    isCompaniesUpdate: state.Crm.isCompaniesUpdate,
    isCompaniesUpdateFail: state.Crm.isCompaniesUpdateFail,
  }));
  ...
  }, [dispatch, isCompaniesSuccess, error, isCompaniesAdd, isCompaniesAddFail, isCompaniesDelete, isCompaniesDeleteFail, isCompaniesUpdate, isCompaniesUpdateFail]);
            ...
            <Col xxl={9}>
              <Card id="companyList">
                ...
                <CardBody>
                  ...
                  {isCompaniesAdd ? <MsgToast msg="Company Added Successfully" color="success" icon="ri-checkbox-circle-line"/> : null}
                  {isCompaniesAddFail ? <MsgToast msg="Company Added Failed" color="danger" icon="ri-error-warning-line"/> : null}
                  {isCompaniesDelete ? <MsgToast msg="Company Deleted Successfully" color="success" icon="ri-checkbox-circle-line"/> : null}
                  {isCompaniesDeleteFail ? <MsgToast msg="Company Deleted Failed" color="danger" icon="ri-error-warning-line"/> : null}
                  {isCompaniesUpdate ? <MsgToast msg="Company Updated Successfully" color="success" icon="ri-checkbox-circle-line"/> : null}
                  {isCompaniesUpdateFail ? <MsgToast msg="Company Updated Failed" color="danger" icon="ri-error-warning-line"/> : null}
