...
const CrmLeads = () => {
  ...
  const { leads, isLeadCreated, isLeadsSuccess, error, isLeadsAdd, isLeadsAddFail, isLeadsDelete, isLeadsDeleteFail, isLeadsUpdate, isLeadsUpdateFail } = useSelector((state) => ({
    ...
    isLeadsDeleteFail: state.Crm.isLeadsDeleteFail,
  ...
  }, [dispatch, isLeadsSuccess, error, isLeadsAdd, isLeadsAddFail, isLeadsDelete, isLeadsDeleteFail, isLeadsUpdate, isLeadsUpdateFail]);
            ...
            <Col lg={12}>
              <Card id="leadsList">
                ...
                <CardBody>
                  ...
                  {isLeadsAdd ? <MsgToast msg="Leads Added Successfully" color="success" icon="ri-checkbox-circle-line"/> : null}
                  {isLeadsAddFail ? <MsgToast msg="Leads Added Failed" color="danger" icon="ri-error-warning-line"/> : null}
                  {isLeadsDelete ? <MsgToast msg="Leads Deleted Successfully" color="success" icon="ri-checkbox-circle-line"/> : null}
                  {isLeadsDeleteFail ? <MsgToast msg="Leads Deleted Failed" color="danger" icon="ri-error-warning-line"/> : null}
                  {isLeadsUpdate ? <MsgToast msg="Leads Updated Successfully" color="success" icon="ri-checkbox-circle-line"/> : null}
                  {isLeadsUpdateFail ? <MsgToast msg="Leads Updated Failed" color="danger" icon="ri-error-warning-line"/> : null}
