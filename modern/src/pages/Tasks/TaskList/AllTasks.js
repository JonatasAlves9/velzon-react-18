...
const AllTasks = () => {
  ...
  const { taskList, isTaskCreated, isTaskSuccess, error, isTaskAdd, isTaskAddFail, isTaskDelete, isTaskDeleteFail, isTaskUpdate, isTaskUpdateFail } = useSelector((state) => ({
  ...
  }, [dispatch, isTaskSuccess, error, isTaskAdd, isTaskAddFail, isTaskDelete, isTaskDeleteFail, isTaskUpdate, isTaskUpdateFail]);
        ...
        <Col lg={12}>
          <div className="card" id="tasksList">
            ...
            <div className="card-body">
              ...
              {isTaskAdd ? <MsgToast msg="Task Added Successfully" color="success" icon="ri-checkbox-circle-line" /> : null}
              {isTaskAddFail ? <MsgToast msg="Task Added Failed" color="danger" icon="ri-error-warning-line" /> : null}
              {isTaskDelete ? <MsgToast msg="Task Deleted Successfully" color="success" icon="ri-checkbox-circle-line" /> : null}
              {isTaskDeleteFail ? <MsgToast msg="Task Deleted Failed" color="danger" icon="ri-error-warning-line" /> : null}
              {isTaskUpdate ? <MsgToast msg="Task Updated Successfully" color="success" icon="ri-checkbox-circle-line" /> : null}
              {isTaskUpdateFail ? <MsgToast msg="Task Updated Failed" color="danger" icon="ri-error-warning-line" /> : null}
