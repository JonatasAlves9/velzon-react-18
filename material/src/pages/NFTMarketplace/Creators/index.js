                            ...
                            <Col key={key}>
                                <Card>
                                    ...
                                    <div className="card-body text-center">
                                        <img src={item.img} alt="" className="avatar-md rounded-circle object-cover mt-n5 border border-5 border-white mx-auto d-block" />
                                        <Link to="/pages-profile">
                                        ...
                                        <button className={item.isFollowBtn ? "btn btn-success w-100" : "btn btn-soft-success w-100"}>{item.followbtn}</button>
                                    </div>
                                </Card>
                            </Col>
                        ))}
