                ...
                <Container fluid>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                <CardHeader>
                                    <h5 className="card-title mb-0">Select2</h5>
                                </CardHeader>
                                <CardBody>
                                <p className="text-muted">Use <code>data-bs-spy="scroll"</code> attribute to update links in a navigation list based on the current scroll position. Scroll the area below the navbar and watch the active class change.</p>
                                    <Row className="g-4">
                                        <Col lg={4}>
