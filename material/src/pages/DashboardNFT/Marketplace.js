                                    ...
                                    <div className="">
                                        <CardHeader className="border-0 align-items-center d-flex">
                                            ...
                                            <div className='d-flex gap-1'>
                                                <button type="button" className="btn btn-soft-secondary shadow-none btn-sm">
                                                    ALL
                                                </button>
                                                <button type="button" className="btn btn-soft-secondary shadow-none btn-sm">
                                                    1M
                                                ...
                                                <button type="button" className="btn btn-soft-primary shadow-none btn-sm">
                                                    1Y
                                                </button>
                                            </div>
                                        </CardHeader>
                                        ...
                                        <MarketplaceChart dataColors='["--vz-primary","--vz-success", "--vz-gray-300"]' />
                                    </div>
                                </Col>
